...
namespace FRIWOCenter.WebAPI.Controllers
{
    [ApiController]
    [Route("[controller]")]
    [Authorize]
    public class ProfileController : ControllerBase
    {
        ...
        private readonly FRIWOCenterContext _context;

        public ProfileController(ILogger<ProfileController> logger, FRIWOCenterContext context)
        {
            this.logger = logger;
            _context = context;
        }
        ...
        {
            var filePath = @"C:\Data\CuriousDrive\GitHub Repos\FRIWOCenter\Documents\Word\ServerFile.docx";
